...
! function() {
    try {
        var e = "undefined" != typeof globalThis ? globalThis : "undefined" != typeof global ? global : "undefined" != typeof window ? window : "undefined" != typeof self ? self : {},
            n = (new e.Error).stack;
        n && ((e._debugIds || (e._debugIds = {}))[n] = "3ac3f293-30d9-363a-9733-730f24f726f9")
    } catch (e) {}
}();
(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push(["object" == typeof document ? document.currentScript : void 0, 448583, e => {
    ...
    e.v({
        title: "Cài đặt Thiệp",
        description: "Chọn thiệp của bạn, quản lý hình ảnh đại diện, chế độ hiển thị, địa chỉ công khai và nội dung hiển thị với khách mời.",
        descriptionMobile: "Quản lý cài đặt thiệp",
        tabs: {
            general: "Chung",
            guestView: "Khách mời"
        },
        selectPage: {
            title: "Chọn Thiệp",
            label: "Trang thiệp",
            placeholder: "Chọn trang để cài đặt",
            helper: "Chọn trang thiệp để cấu hình."
        },
        seoImage: {
            title: "Hình đại diện & Xem trước",
            changeImage: "Thay đổi Hình ảnh",
            dragDrop: "Kéo & thả hình ảnh vào đây",
            uploadButton: "Tải lên Hình ảnh",
            previewLaptop: "Xem trước Desktop",
            previewMobile: "Xem trước Mobile",
            note: "Khuyến nghị 1200×630px (JPG/PNG)",
            selectImageTitle: "Chọn hình ảnh SEO"
        },
        publication: {
            title: "Hiển thị",
            publishTitle: "Thiệp công khai",
            publishDescription: "Bất kỳ ai có link đều có thể xem thiệp của bạn",
            publicTitle: "Hiển thị trên meHappy Marketplace",
            publicDescription: "Hiển thị thiệp của bạn trong thư viện công khai"
        },
        domain: {
            title: "Địa chỉ website",
            currentUrl: "URL hiện tại",
            live: "Đang hoạt động",
            currentDomain: "Địa chỉ hiện tại:",
            currentlyUsing: "Đang sử dụng",
            defaultSubdomain: "Tên miền mặc định",
            defaultSubdomainHelper: "Đây sẽ là URL thiệp công khai của bạn",
            defaultDomain: "Tên miền mặc định",
            defaultDomainRequired: "Vui lòng nhập tên miền mặc định",
            defaultDomainPattern: "Chỉ được sử dụng chữ thường, số và dấu gạch ngang",
            defaultDomainMinLength: "Tên miền phải có ít nhất 3 ký tự",
            domainError: "Lỗi kiểm tra tên miền",
            checkingAvailability: "Đang kiểm tra tính khả dụng...",
            domainNote: 'Địa chỉ website phải lớn hơn 3 và nhỏ hơn 63 kí tự (a-z 0-9), có thể sử dụng ký tự "-".',
            customDomainToggle: "Sử dụng Tên miền Tùy chỉnh",
            customDomainDescription: "Kết nối tên miền riêng của bạn",
            customDomain: "Tên miền Tùy chỉnh",
            customDomainRequired: "Vui lòng nhập tên miền tùy chỉnh",
            customDomainPattern: "Định dạng tên miền không hợp lệ. Chỉ sử dụng chữ cái, số, dấu gạch ngang và dấu chấm",
            customDomainNote: "Nhập tên miền đầy đủ của bạn (ví dụ: mydomain.com)",
            domainUnavailable: "Tên miền không khả dụng",
            stillChecking: "Đang kiểm tra tên miền",
            pleaseWait: "Vui lòng đợi kiểm tra tên miền hoàn tất",
            verification: {
                success: "Xác minh tên miền thành công",
                successDescription: "Tên miền của bạn đã được xác minh thành công",
                failed: "Xác minh tên miền thất bại"
            },
            errors: {
                notFound: "Không tìm thấy trang",
                noCustomDomain: "Vui lòng nhập tên miền tùy chỉnh",
                cnameNotFoundDesc: "Không tìm thấy bản ghi CNAME. Vui lòng kiểm tra cài đặt DNS của bạn.",
                tryAgain: "Vui lòng thử lại sau"
            },
            systemDomain: {
                autoVerified: "Tên miền hệ thống được tự động xác minh"
            },
            instructions: {
                title: "Hướng dẫn sử dụng tên miền",
                line1: "Tên miền không được nhập kèm www. (Ví dụ: chỉ được nhập abc.com, không được nhập www.abc.com). Sau khi cài đặt tên miền riêng vào hệ thống, hãy đến hệ thống quản trị tên miền của bạn và thiết lập 2 bản ghi như sau:",
                line2: "Tên miền hiện tại của bạn là",
                line3: "nhưng bạn có thể thêm tên miền tùy chỉnh để giúp website của bạn trở nên chuyên nghiệp hơn, in đậm đều ấn có nhấn hơn và trở nên độc đáo hơn trong mắt người khác."
            }
        },
        save: "LƯU THÔNG TIN",
        selectPageError: "Vui lòng chọn trang để cập nhật",
        updateSuccess: "Cập nhật thành công",
        updateError: "Lỗi cập nhật",
        publishSuccess: "Đã công khai thiệp",
        publishSuccessDescription: "Thiệp của bạn đã được công khai và có thể truy cập qua link.",
        publishError: "Lỗi công khai thiệp",
        publishErrorDescription: "Không thể công khai thiệp.",
        unpublishSuccess: "Đã ẩn thiệp",
        unpublishSuccessDescription: "Thiệp của bạn đã được ẩn và không thể truy cập qua link.",
        unpublishError: "Lỗi ẩn thiệp",
        unpublishErrorDescription: "Không thể ẩn thiệp.",
        tierUpgradeRequired: "Cần nâng cấp gói",
        tierUpgradeDescription: "Bạn cần nâng cấp gói lớn hơn hoặc bằng mẫu này để xuất bản",
        tierUpgradeFeatureName: "Nâng cấp gói để xuất bản",
        guestView: {
            modalTitle: "Cài đặt SEO cho khách mời",
            titleForGuest: "Tiêu đề cho khách mời",
            titlePlaceholder: "Ví dụ: Chào mừng, {guestName}!",
            titleHelper: "Hiển thị trong kết quả tìm kiếm và trên thẻ chia sẻ khi khách mời sử dụng link riêng.",
            descriptionForGuest: "Mô tả cho khách mời",
            descriptionPlaceholder: "Thân gửi {guestName}, chúng tôi rất hân hạnh được mời bạn đến chia sẻ ngày đặc biệt của chúng tôi...",
            descriptionHelper: "Hiển thị bên dưới tiêu đề trên thẻ chia sẻ. Giữ ngắn gọn.",
            availableVariables: "Các biến có sẵn",
            fullName: "Họ và tên",
            email: "Email",
            phoneNumber: "Số điện thoại",
            viewExamples: "Xem ví dụ",
            infoNote: "Nếu để trống, tiêu đề và mô tả mặc định của trang sẽ được sử dụng.",
            beforeRawText: "Trước khi render (text gốc)",
            title: "Tiêu đề:",
            description: "Mô tả:",
            renderedExample: "Ví dụ đã render",
            useSampleData: "Sử dụng dữ liệu mẫu",
            titleShown: "Tiêu đề hiển thị:",
            descriptionShown: "Mô tả hiển thị:",
            sharePreview: "Xem trước khi chia sẻ",
            sharePreviewDescription: "Đây là cách thiệp của bạn hiển thị khi được chia sẻ hoặc khi khách mời mở link riêng.",
            sharePreviewDescriptionMobile: "Cách thiệp của bạn hiển thị khi được chia sẻ hoặc mở qua link riêng.",
            desktopShareCard: "Thẻ chia sẻ Desktop",
            mobileShareCard: "Thẻ chia sẻ Mobile",
            shareCardPreview: "Xem trước thẻ chia sẻ",
            shareInfoNote: "Nếu tiêu đề/mô tả để trống, giá trị mặc định của trang sẽ được sử dụng.",
            saveButton: "Lưu cài đặt",
            saveSuccess: "Đã lưu cài đặt cho khách mời thành công!",
            saveError: "Lỗi khi lưu cài đặt khách mời",
            selectPageError: "Vui lòng chọn trang thiệp",
            titleRequired: "Vui lòng nhập tiêu đề cho khách mời",
            descriptionRequired: "Vui lòng nhập mô tả cho khách mời",
            variables: {
                guestNameDesc: "Tên đầy đủ của khách mời",
                guestNameExample: "Nguyễn Văn A",
                guestEmailDesc: "Email của khách mời",
                guestEmailExample: "nguyenvana@email.com",
                guestPhoneDesc: "Số điện thoại của khách mời",
                guestPhoneExample: "0123456789"
            },
            modal: {
                title: "Hướng dẫn sử dụng biến cá nhân hóa",
                howItWorks: "Cách hoạt động",
                howItWorksDesc: "Khi khách mời truy cập trang qua link riêng (có chứa guestId), hệ thống sẽ tự động thay thế các biến bằng thông tin thực tế của khách mời đó.",
                availableVariablesTitle: "Danh sách biến có thể sử dụng:",
                variable: "Biến",
                examplePrefix: "Ví dụ:",
                usageExample: "📝 Ví dụ sử dụng:",
                exampleTitle: "Tiêu đề:",
                exampleTitleValue: "Thiệp dành riêng cho {guestName}",
                exampleDescription: "Mô tả:",
                exampleDescriptionValue: "Xin chào {guestName}! Chúng tôi rất hân hạnh được mời bạn đến dự lễ của chúng tôi. Vui lòng xác nhận tham dự qua email {guestEmail}.",
                importantNote: "Lưu ý quan trọng",
                note1: "• Các biến chỉ hoạt động khi khách mời truy cập qua link có chứa guestId",
                note2: "• Nếu khách mời chưa có thông tin, biến sẽ hiển thị giá trị mặc định",
                note3: "• Các biến phân biệt chữ hoa chữ thường"
            }
        }
    })
}, 858026, e => {
...
//# debugId=3ac3f293-30d9-363a-9733-730f24f726f9
//# sourceMappingURL=01477cf6c93252be.js.map