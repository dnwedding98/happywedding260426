...
! function() {
    try {
        var e = "undefined" != typeof globalThis ? globalThis : "undefined" != typeof global ? global : "undefined" != typeof window ? window : "undefined" != typeof self ? self : {},
            n = (new e.Error).stack;
        n && ((e._debugIds || (e._debugIds = {}))[n] = "8e4260b5-0f76-f2f1-33d4-62f64cdcc37c")
    } catch (e) {}
}();
(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push(["object" == typeof document ? document.currentScript : void 0, 448583, e => {
    ...
    e.v({
        ...
        messages: {
            ...
            copyLink: "Copy link",
            copyAndClearCache: "Copy clear cache (use when you just changed the invitation)",
    ...
    e.v({
        ...
        assets: {
            ...
            noAssetsWithFilters: "No icon templates match current filters",
            featuredTitle: "Featured Wedding Icons",
        ...
        styles: {
            ...
            twemojiColor: "Twemoji Color",
            notoColor: "Noto Color",
            mono: "Mono",
            template: "Template"
        },
        system: {
            featuredMulticolorTitle: "Featured Multicolor",
            suggestedTitle: "Suggested For Wedding",
            allIconsTitle: "All System Icons",
            loadMore: "Show {{count}} more icons"
        },
        modes: {
            multicolorPreferred: "Multicolor (Best)",
            basic: "Basic",
            all: "All",
            multicolor: "Multicolor Only"
        },
        search: {
            placeholder: "Search icons...",
            noResults: "No icons found",
            noResultsWithFilters: "No icons match current filters"
        },
        upload: {
    ...
    e.v({
        ...
        iconSystem: {
            modeMulticolor: "Multicolor (pretty)",
            modeBasic: "Basic",
            modeAll: "All",
            searchPlaceholder: "Search system icons...",
            featured: "Featured icons",
            allIcons: "All system icons",
            showMore: "Show more",
            resultCount: "Showing {{visible}}/{{total}} icons",
        ...
        messages: {
            ...
            assetDeleteUnavailableTitle: "Cannot delete template",
            assetDeleteUnavailableDescription: "This template has no ID yet, so it cannot be deleted. Please re-save the template or reload the page."
        },
        fileTab: {
            inPage: "In Page",
            templates: "Templates",
    ...
    e.v({
        ...
        copyRefreshFB: "Copy clear cache (use when you just changed the invitation)",
    ...
    e.v({
        ...
        messages: {
            ...
            copyAndClearCache: "Copy xóa cache ( dùng khi bạn vừa có thay đổi về thiệp)",
    ...
    e.v({
        ...
        assets: {
            ...
            noAssetsWithFilters: "Không có mẫu icon phù hợp với bộ lọc hiện tại",
            featuredTitle: "Icon cưới nổi bật",
            allTemplatesTitle: "Tất cả mẫu icon"
        },
        categories: {
            all: "Tất cả",
            featured: "Nổi bật",
            love: "Tình yêu",
            couple: "Cặp đôi",
            ceremony: "Nghi lễ cưới",
            invitation: "Thiệp mời",
            calendarTime: "Lịch & thời gian",
            locationTransport: "Địa điểm & di chuyển",
            mediaMusic: "Media & âm nhạc",
            socialContact: "Mạng xã hội & liên hệ",
            decorNature: "Trang trí & thiên nhiên",
            utility: "Tiện ích"
        },
        libraries: {
            all: "Tất cả thư viện",
            fontawesome: "Font Awesome",
            iconify: "Iconify đa màu",
            template: "Mẫu icon"
        },
        styles: {
            all: "Tất cả style",
        ...
        system: {
            featuredMulticolorTitle: "Icon đa màu nổi bật",
            suggestedTitle: "Gợi ý cho trang cưới",
            allIconsTitle: "Tất cả icon hệ thống",
            loadMore: "Xem thêm {{count}} biểu tượng"
        },
        modes: {
            multicolorPreferred: "Đa màu (đẹp)",
            basic: "Cơ bản",
            all: "Tất cả",
            multicolor: "Chỉ đa màu"
        },
        search: {
            placeholder: "Tìm kiếm biểu tượng...",
            noResults: "Không tìm thấy biểu tượng nào",
            noResultsWithFilters: "Không có biểu tượng phù hợp với bộ lọc hiện tại"
        },
        upload: {
    ...
    e.v({
        ...
        assetGroups: {
            private: "Mẫu của bạn",
            public: "Mẫu hệ thống",
            systemIcons: "Icon hệ thống"
        },
        iconSystem: {
            modeMulticolor: "Đa màu (đẹp)",
            modeBasic: "Cơ bản",
            modeAll: "Tất cả",
            searchPlaceholder: "Tìm icon hệ thống...",
            featured: "Icon nổi bật",
            allIcons: "Tất cả icon hệ thống",
            showMore: "Xem thêm",
            resultCount: "Hiển thị {{visible}}/{{total}} biểu tượng",
            noResults: "Không tìm thấy icon phù hợp"
        },
        messages: {
            loading: "Loading ...",
            ...
            assetDeleteUnavailableTitle: "Không thể xóa mẫu",
            assetDeleteUnavailableDescription: "Mẫu này thiếu ID nên chưa thể xóa. Vui lòng lưu lại mẫu hoặc tải lại trang."
        },
        fileTab: {
            inPage: "Trong trang",
            templates: "Mẫu",
    ...
    e.v({
        ...
        copyRefreshFB: "Copy xóa cache ( dùng khi bạn vừa có thay đổi về thiệp)",
...
//# debugId=8e4260b5-0f76-f2f1-33d4-62f64cdcc37c
//# sourceMappingURL=a4032fb257ebd0b5.js.map